...
# 1. Visita [Youtube Channel](https://www.youtube.com/@IA.Sistema.de.Interes) Para poder obtener la extensión para Chrome para extraer la API no oficial con la cual funciona los nodos

En este entorno de trabajo puedes generar con el modelo de Google Image v3.5 de 1 imagen hasta 4 al mismo tiempo, cambiar la relación de aspecto: 16:9, 9:16, 1:1, cambiar la semilla o usar el método random, cambiar el directorio donde se guardan las imágenes
...
Este segundo entorno de trabajo puedes generar hasta 4 imágenes al mismo tiempo, se trata del generador de referencia de whisk, puedes cargar hasta 3 imágenes como referencia para crear una única imagen.
...
En este tercer entorno de trabajo les traigo el modelo de Nano Banana, con la capacidad de generar hasta 4 imágenes con hasta 3 imágenes de referencia.
Aquí les dejo 3 ejemplos.
Con 1 imagen
